...
$filter_by_category_and_urgency = filter_by_category_and_urgency($dbconn, $maintenance_category, $maintenance_urgency);

foreach($filter_by_category_and_urgency as $data){
    echo '<tr>';
