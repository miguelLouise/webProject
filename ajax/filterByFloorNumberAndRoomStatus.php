...
$filter_by_floor_number_and_room_status = filter_by_floor_number_and_room_status($dbconn, $floor_number, $room_status);

foreach($filter_by_floor_number_and_room_status as $data){
    echo '<tr>';
