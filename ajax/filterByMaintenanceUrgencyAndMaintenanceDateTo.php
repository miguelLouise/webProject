...
$filter_by_urgency_and_date_to = filter_by_urgency_and_date_to($dbconn, $maintenance_urgency, $maintenance_date_to);

foreach($filter_by_urgency_and_date_to as $data){
    echo '<tr>';
