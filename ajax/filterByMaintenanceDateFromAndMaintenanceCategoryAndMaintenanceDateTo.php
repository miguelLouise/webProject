...
$filter_by_date_from_and_category_and_date_to = filter_by_date_from_and_category_and_date_to($dbconn, $maintenance_date_from, $maintenance_category, $maintenance_date_to);

foreach($filter_by_date_from_and_category_and_date_to as $data){
    echo '<tr>';
