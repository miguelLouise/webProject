...
$filter_by_urgency_and_date_from = filter_by_urgency_and_date_from($dbconn, $maintenance_urgency, $maintenance_date_from);

foreach($filter_by_urgency_and_date_from as $data){
    echo '<tr>';
