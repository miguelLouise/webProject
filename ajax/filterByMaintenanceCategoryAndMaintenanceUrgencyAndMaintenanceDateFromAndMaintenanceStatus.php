...
$filter_by_category_and_urgency_and_date_from_and_status = filter_by_category_and_urgency_and_date_from_and_status($dbconn, $maintenance_category, $maintenance_urgency, $maintenance_date_from, $maintenance_status);

foreach($filter_by_category_and_urgency_and_date_from_and_status as $data){
    echo '<tr>';
