...
$filter_by_category_and_date_to = filter_by_category_and_date_to($dbconn, $maintenance_category, $maintenance_date_to);

foreach($filter_by_category_and_date_to as $data){
    echo '<tr>';
