...
$filter_by_category_and_urgency_and_date_from = filter_by_category_and_urgency_and_date_from($dbconn, $maintenance_category, $maintenance_urgency, $maintenance_date_from);

foreach($filter_by_category_and_urgency_and_date_from as $data){
    echo '<tr>';
