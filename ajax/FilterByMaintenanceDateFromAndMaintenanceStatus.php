...
$filter_by_date_from_and_status = filter_by_date_from_and_status($dbconn, $maintenance_date_from, $maintenance_status);

foreach($filter_by_date_from_and_status as $data){
    echo '<tr>';
