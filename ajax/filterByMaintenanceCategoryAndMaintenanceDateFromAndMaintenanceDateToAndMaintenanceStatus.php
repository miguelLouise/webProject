...
$filter_by_category_and_date_from_and_date_to_and_status = filter_by_category_and_date_from_and_date_to_and_status($dbconn, $maintenance_category, $maintenance_status, $maintenance_date_from, $maintenance_date_to);

foreach($filter_by_category_and_date_from_and_date_to_and_status as $data){
    echo '<tr>';
