...
$filter_by_category_and_urgency_and_date_from_and_date_to = filter_by_category_and_urgency_and_date_from_and_date_to($dbconn, $maintenance_category, $maintenance_urgency, $maintenance_date_from, $maintenance_date_to);

foreach($filter_by_category_and_urgency_and_date_from_and_date_to as $data){
    echo '<tr>';
