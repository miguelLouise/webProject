...
$filter_by_date_to_and_category_and_status = filter_by_date_to_and_category_and_status($dbconn, $maintenance_date_to, $maintenance_category, $maintenance_status);

foreach($filter_by_date_to_and_category_and_status as $data){
    echo '<tr>';
