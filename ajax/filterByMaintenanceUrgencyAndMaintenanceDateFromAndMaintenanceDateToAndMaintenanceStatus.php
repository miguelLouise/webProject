...
$filter_by_urgency_and_date_from_and_date_to_and_status = filter_by_urgency_and_date_from_and_date_to_and_status($dbconn, $maintenance_urgency, $maintenance_date_from, $maintenance_date_to,$maintenance_status);

foreach($filter_by_urgency_and_date_from_and_date_to_and_status as $data){
    echo '<tr>';
