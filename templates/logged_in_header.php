...
<body>
    ...
    <div class="side_nav_div">
        <div class="side_nav" id="menu_nav">
            <div class="user_info">
            <img src="../Assets/profile.png" class="user_icon">
            ...
            <div class="side_nav_con2">
                <ul>
                    ...
                    <li><a href="../messaging_page.php"><button class="nav_btn"><img src="../Assets/mail.png" class="nav_icon">Send us an email</button></a></li>
